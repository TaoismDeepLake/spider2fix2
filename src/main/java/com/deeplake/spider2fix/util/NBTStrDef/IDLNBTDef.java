package com.deeplake.spider2fix.util.NBTStrDef;
...
public class IDLNBTDef {
	...
	public static final String NAME_OFF= "spider2fix.shared.off";
	public static final String NAME_ON= "spider2fix.shared.on";
	...
	//gua socket
	public static final String GUA_NO_FREE_SOCKET_DESC = "spider2fix.gua_enhance_no_free.desc";
	public static final String GUA_FREE_SOCKET_DESC = "spider2fix.gua_enhance_free.desc";
	public static final String GUA_TOTAL_SOCKET_DESC = "spider2fix.gua_enhance_total.desc";
	public static final String GUA_N_A_DESC = "spider2fix.gua_not_applicable.desc";
	...
	public static final String KILL_COUNT_DESC = "spider2fix.kill_count.desc";
