...
public class ModConfig {
    ...
    @Config.LangKey("configgui.spider2fix.category.Menu0.GeneralConf")
...
//        @Config.LangKey("spider2fix.conf.general.welcome")
//        @Config.Comment("The text shown when a player logs in. Can be a key or a string.")
//        public String WELCOME_MSG = "spider2fix.msg.welcome";
    }

    @Config.LangKey("configgui.spider2fix.category.Menu0.DebugConf")
    ...
    @Config.LangKey("configgui.spider2fix.category.Menu0.SpawnConf")
