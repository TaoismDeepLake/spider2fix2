...
import com.deeplake.spider2fix.util.IDLGeneral;
...
import static com.deeplake.spider2fix.util.NBTStrDef.IDLNBTDef.STATE;
import static com.deeplake.spider2fix.util.NBTStrDef.IDLNBTUtil.GetInt;
import static com.deeplake.spider2fix.util.NBTStrDef.IDLNBTUtil.SetInt;

public class ItemHateDetector extends ItemSkillBase {

    private Class<? extends EntityLiving> targetCategory = EntityLiving.class;
    private String msgKey = "spider2fix.msg.being_targeted";
